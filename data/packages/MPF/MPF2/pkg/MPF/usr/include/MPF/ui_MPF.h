...
public:
    ...
    void setupUi(QMainWindow *MPF)
    {
        ...
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 689, 156));
        ...
        scrollAreaWidgetContents_2->setGeometry(QRect(0, 0, 687, 153));
    ...
    void retranslateUi(QMainWindow *MPF)
    {
        ...
        pushButton->setText(QApplication::translate("MPF", "PushButton", 0, QApplication::UnicodeUTF8));
